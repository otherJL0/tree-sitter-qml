...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [26] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 1),
  [28] = {.entry = {.count = 1, .reusable = true}}, SHIFT(15),
  [30] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_qualified_import, 3),
  ...
  [38] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_module, 3),
